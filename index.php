...
label{text-shadow: 9px;font-size: 16px;font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;font-style: oblique;color: black;padding: 19px;margin: auto;display: flex;flex-direction: column;align-items: center;justify-content: center;text-align: center;}
...
input{text-align: left;text-shadow: 9px;width: 300px;margin: auto;border-radius: 10px 10px;padding: 5px;font-size: 16px;font-family: Cambria, Cochin, Georgia, Times, 'Times New Roman', serif;font-style: inherit;background-color: whitesmoke;color: black;border: 4px solid blue;cursor: alias;}
